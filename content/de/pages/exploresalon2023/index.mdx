...
image: /assets/content/assets/de/pages/exploresalon2023/image.png
summary: >
...
![Results](/assets/content/assets/de/pages/exploresalon2023/bildschirmfoto-2023-06-07-um-10.04.05-1024x146.png)

Click <Link link={{ discriminant: "download", value: "/assets/content/downloads/de/pages/exploresalon2023/OutcomesExploreSalon2023.pdf" }}>here</Link> to view the results of various ExploreSalon project outcomes:
...
![](/assets/content/assets/de/pages/exploresalon2023/final-overview.png)
...
![What we are doing](/assets/content/assets/de/pages/exploresalon2023/what-we-are-doing-2.png)
...
![What's in for you](/assets/content/assets/de/pages/exploresalon2023/whats-in-for-you-3.png)
...
![Who we are looking for](/assets/content/assets/de/pages/exploresalon2023/who-we-are-looking-for-1-1024x82.png)
...
![Tentative programme](/assets/content/assets/de/pages/exploresalon2023/tentative-programme-exploresalon.png)
...
![Where we will gather](/assets/content/assets/de/pages/exploresalon2023/where-we-will-gather-1-1024x93.png)
...
![Organisation](/assets/content/assets/de/pages/exploresalon2023/organisation.png)

**Organising Committee**

<Grid layout="three-columns">
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_charvat_d184b341fc-150x150.png" maxSize={180} variant="circle">
    	Vera Maria Charvat\
    	ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_durco_4f69196218-150x150.png" maxSize={180} variant="circle">
	    Matej Ďurčo\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/elkoen-1-150x150.png" maxSize={180} variant="circle">
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/sylvia-petrovic-majer-150x150.png" maxSize={180} variant="circle">
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_woldrich2_4c2c576992-1-150x150.png" maxSize={180} variant="circle">
	    Anna Woldrich\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
...
<Grid layout="three-columns">
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_carloni.png" maxSize={180} variant="circle">
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/martin-krickl-onb.png" maxSize={180} variant="circle">
	    Martin Krickl\
  	  (ÖNB)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_kunzmann.png" maxSize={180} variant="circle">
	    Markus Kunzmann\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/simon-mayer-onb.png" maxSize={180} variant="circle">
	    Simon Mayer\
  	  (ÖNB)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_mueller.png" maxSize={180} variant="circle">
	    Martin Anton Müller\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_pirgie.png" maxSize={180} variant="circle">
	    Gregor Pirgie\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_rastinger.png" maxSize={180} variant="circle">
	    Nina C. Rastinger\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/christoph-steindl-onb.png" maxSize={180} variant="circle">
	    Christoph Steindl\
  	  (ÖNB)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/assets/de/pages/exploresalon2023/csm_team_untner.png" maxSize={180} variant="circle">
	    Laura Untner\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
...
<Grid layout="four-columns">
	<GridItem>
		![](/assets/content/assets/de/pages/exploresalon2023/osterreichische-akademie-der-wissenschaften.png)
	</GridItem>

	<GridItem>
		![](/assets/content/assets/de/pages/exploresalon2023/acdh-ch.png)
	</GridItem>

	<GridItem>
		![](/assets/content/assets/de/pages/exploresalon2023/austrian-national-library.png)
	</GridItem>

	<GridItem>
		![](/assets/content/assets/de/pages/exploresalon2023/Ditah-02.png)
	</GridItem>
</Grid>
