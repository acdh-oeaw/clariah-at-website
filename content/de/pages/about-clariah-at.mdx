...
image: /assets/content/de/pages/about-clariah-at/image.jpg
summary: >
...
<Grid variant="two-columns">
  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "austrian-academy-of-sciences" }} src="/assets/content/de/pages/about-clariah-at/Österreichische Akademie der Wissenschaften.png" text="Österreichische Akademie der Wissenschaften">

    </ImageLink>
  </GridItem>

  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "austrian-national-library" }} src="/assets/content/de/pages/about-clariah-at/austrian-national-library.png" text="Österreichische Nationalbibliothek">

    </ImageLink>
  </GridItem>

  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "university-for-continuing-education-krems" }} src="/assets/content/de/pages/about-clariah-at/Universität für Weiterbildung Krems.png" text="Universität für Weiterbildung Krems">

    </ImageLink>
  </GridItem>

  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "university-of-graz" }} src="/assets/content/de/pages/about-clariah-at/Universität Graz.png" text="Universität Graz">

    </ImageLink>
  </GridItem>

  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "university-of-innsbruck" }} src="/assets/content/de/pages/about-clariah-at/university-of-innsbruck.png" text="Universität Innsbruck">

    </ImageLink>
  </GridItem>

  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "university-of-klagenfurt" }} src="/assets/content/de/pages/about-clariah-at/university-of-klagenfurt.png" text="Universität Klagenfurt">

    </ImageLink>
  </GridItem>

  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "university-of-salzburg" }} src="/assets/content/de/pages/about-clariah-at/university-of-salzburg.png" text="Universität Salzburg">

    </ImageLink>
  </GridItem>

  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "university-of-vienna" }} src="/assets/content/de/pages/about-clariah-at/university-of-vienna.png" text="Universität Wien">
...
<Grid variant="two-columns">
  <GridItem>
    <ImageLink link={{ discriminant: "consortium", value: "university-of-music-and-performing-arts-vienna" }} src="/assets/content/de/pages/about-clariah-at/mdw-logo-de.png" text="Universität für Musik und darstellende Kunst Wien">
