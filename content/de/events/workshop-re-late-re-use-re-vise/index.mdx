...
(nächst dem Eingang zum Sisi-Museum unter der Michaelerkuppel, aber vor dem Betreten des Museums rechts abbiegen; siehe [hier](https://goo.gl/maps/aTczKZYA9Vza83rV9) für den Weg zum Sisi-Museum und [hier](https://evsl.univie.ac.at/fileadmin/user_upload/i_evsl/Jura_Soyfer_Saal.jpg) für einen Gebäudeplan).

**Vortragssprache:** Englisch

**Registrierung:** Bitte senden Sie eine kurze Nachricht an [Gabriel Viehhauser](javascript:linkTo_UnCryptMailto\('ocknvq,icdtkgn0xkgjjcwugtBwpkxkg0ce0cv'\);).
