...
date: 2025-11-20
image: /assets/content/assets/de/events/workshop-re-late-re-use-re-vise/image.png
eventDate: 2025-12-04
summary: >-
  (4.12.2025, Wien) Workshop zu "Large Language Models and Their Potential for
...
**Wann:** Donnerstag, 4. Dezember 2025: 9:00 - 16:45 Uhr

**Wo:** Jura Soyfer Saal, Hofburg, Batthyanystiege 1010 Wien\
(gleich neben dem Eingang zum Sisi Museum unter der Michaela Kuppel, gehen Sie nach rechts bevor Sie in das Museum gehen. [Hier](https://goo.gl/maps/aTczKZYA9Vza83rV9) erfahren Sie wie Sie zum Sisi Museum kommen, und hier gibts eine [Karte des Gebäudes](https://evsl.univie.ac.at/fileadmin/user_upload/i_evsl/Jura_Soyfer_Saal.jpg)).

**Vortragssprache:** Englisch

**Registrierung:** Bitt senden Sie eine kurze Nachricht an [Gabriel Viehhauser](javascript:linkTo_UnCryptMailto\('ocknvq,icdtkgn0xkgjjcwugtBwpkxkg0ce0cv'\);).
...
Das Ziel unseres Workshops ist es, in dieser Situation das Anwendungspotenzial von Large Language Models (LLMs) im Bereich der digitalen Edition und der computationellen literaturwissenschaftlichen Analyse zu erproben, und zwar sehr konkret anhand eines klassischen Anwendungsfalls dieser Disziplinen, nämlich auf dem Gebiet der Erkennung, Visualisierung und Analyse von Textvarianten und Intertextualität, um so die methodischen Neuerungen an geisteswissenschaftlich relevante Fragestellungen rückzubinden. LLMs eröffnen neue Wege, semantisch und kontextuell ähnliche Textpassagen in umfangreichen Korpora zu identifizieren – selbst über Sprach- und Editionsgrenzen hinweg. Gerade in der philologischen Arbeit mit Überlieferungsvarianten, Adaptionen und intertextuellen Bezügen können solche Modelle sinnvoll eingesetzt werden, durchaus auch komplementär zu bestehenden qualitativen und quantitativen Methoden. Der Workshop richtet sich damit an Forscher\*innen und Studierende aus Literaturwissenschaft, Editorik und Digital Humanities sowie verwandten Disziplinen. Im Zentrum stehen neben methodischen Impulsvorträgen praktische Anwendungsbeispiele, in denen der Einsatz von LLMs systematisch diskutiert, methodisch reflektiert und anwendungsnah erprobt werden soll.
