...
Es werden Einreichung von Langbeiträgen (6–8 Seiten), Kurzbeiträgen (4 Seiten) sowie Demo-Beiträgen (4 Seiten) akzeptiert, die im Rahmen des Workshops als längere oder kürzere mündliche Präsentationen oder als Poster präsentiert werden. Zur Unterstützung des Double-Blind-Review-Verfahrens müssen alle Einreichungen vollständig anonymisiert sein und gemäß dem auf der [LREC-2026-Website](https://lrec2026.info/authors-kit/) verfügbaren Styleguide formatiert werden. Die Beiträge des Workshops werden in Online-Proceedings veröffentlicht.
