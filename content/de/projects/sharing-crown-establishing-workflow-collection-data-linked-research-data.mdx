...
* Öffentliches GitHub Repository mit den Best Practices (Tutorial), sowie allen Skripten, Input-  \
  und Outputdaten: [https://github.com/DigitalHumanitiesCraft/crown](https://github.com/DigitalHumanitiesCraft/crown) 
