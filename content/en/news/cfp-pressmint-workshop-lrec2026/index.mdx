...
Accepted submissions include long papers (from 6 to 8 pages), short papers (4 pages) and demo papers (4 pages)which are to be presented as a long or short oral presentation or poster presentations at the workshop. To support double-blind reviewing, all submissions must be fully anonymized and should be formatted according to the stylesheet available on the [LREC 2026 website](https://lrec2026.info/authors-kit/). The papers of the workshop will be published in online proceedings. 
