...
* Public GitHub repository with the best practices (tutorial), as well as all scripts, input  \
  and output data: [https://github.com/DigitalHumanitiesCraft/crown](https://github.com/DigitalHumanitiesCraft/crown)
