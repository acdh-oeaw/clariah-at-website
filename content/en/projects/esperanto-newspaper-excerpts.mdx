...
endDate: 2024-03-31
image: /assets/content/en/projects/esperanto-newspaper-excerpts/image.png
additionalImages: []
attachments: []
links: []
responsiblePersons:
...
![](/assets/content/en/projects/esperanto-newspaper-excerpts/projektbeschreibung-1024x649.png)

The image shows a section of an original scan of a newspaper article with a two-column layout.

![](/assets/content/en/projects/esperanto-newspaper-excerpts/projektbeschreibung-annotiert-1024x649.png)

The picture shows the result of the layout analysis, where relevant text boxes were recognised and marked.

![](/assets/content/en/projects/esperanto-newspaper-excerpts/projektbeschreibung-code-1024x672.png)
