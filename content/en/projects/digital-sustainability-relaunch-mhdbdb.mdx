...
- Workshop "Schnittstelle Mediävistik" (co-funding with CLARIAH-AT and DFG): <InternalLink resource={{ discriminant: "events", value: "workshop-interface-of-medieval-studies" }}>https://clariah.at/de/events/workshop-interface-of-medieval-studies</InternalLink>;\
...
Additionally, the MHDBD was presented within the framework of the <InternalLink resource={{ discriminant: "events", value: "dazzling-data-lectureseries-izmf-23-24" }}>"Dazzling Data"</InternalLink> Lecture Circuit at the University of Salzburg, a recording of the lecture is available via YouTube:
