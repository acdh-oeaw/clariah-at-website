...
endDate: 2024-03-31
image: >-
  /assets/content/assets/en/projects/digital-edition-creation-pipelines-tools-and-transitions/image.png
additionalImages: []
attachments: []
links: []
responsiblePersons:
...
![](/assets/content/assets/en/projects/digital-edition-creation-pipelines-tools-and-transitions/digedtnt-website.png)

* <Link link={{ discriminant: "events", value: "digedtnt-workshop-meet-the-tools-and-developers-2" }}>DigEdTnT: Workshop – Meet the Tools and Developers</Link>\
...
* <Link link={{ discriminant: "events", value: "webinar-series-digital-editions-tools-transitions" }}>DigEdTnT Webinar Series – Digital Editions: Tools & Transitions</Link>\
