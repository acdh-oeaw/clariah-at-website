...
Click <Link link={{ discriminant: "download", value: "/assets/content/en/pages/exploresalon2023/OutcomesExploreSalon2023.pdf" }}>here</Link> to view the results of various ExploreSalon project outcomes:
...
<Grid layout="three-columns">
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_charvat_d184b341fc-150x150.png" maxSize={180} variant="circle">
    	Vera Maria Charvat\
    	ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_durco_4f69196218-150x150.png" maxSize={180} variant="circle">
	    Matej Ďurčo\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/elkoen-1-150x150.png" maxSize={180} variant="circle">
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/sylvia-petrovic-majer-150x150.png" maxSize={180} variant="circle">
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_woldrich2_4c2c576992-1-150x150.png" maxSize={180} variant="circle">
	    Anna Woldrich\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
...
<Grid layout="three-columns">
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_carloni.png" maxSize={180} variant="circle">
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/martin-krickl-onb.png" maxSize={180} variant="circle">
	    Martin Krickl\
  	  (ÖNB)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_kunzmann.png" maxSize={180} variant="circle">
	    Markus Kunzmann\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/simon-mayer-onb.png" maxSize={180} variant="circle">
	    Simon Mayer\
  	  (ÖNB)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_mueller.png" maxSize={180} variant="circle">
	    Martin Anton Müller\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_pirgie.png" maxSize={180} variant="circle">
	    Gregor Pirgie\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_rastinger.png" maxSize={180} variant="circle">
	    Nina C. Rastinger\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/christoph-steindl-onb.png" maxSize={180} variant="circle">
	    Christoph Steindl\
  	  (ÖNB)
		</Avatar>
  </GridItem>
  ...
  <GridItem>
		<Avatar src="/assets/content/en/pages/exploresalon2023/csm_team_untner.png" maxSize={180} variant="circle">
	    Laura Untner\
  	  ACDH-CH (ÖAW)
		</Avatar>
  </GridItem>
