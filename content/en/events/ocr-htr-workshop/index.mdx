...
summary: >-
  3.–4.10.2025 (Vienna): An international exchange on OCR and HTR solutions –
  for more inclusive research infrastructures in the digital humanities, with a
  focus on languages with non-Latin scripts.
---
**When:** Friday, October 3rd & Saturday, October 4th 2025

**Where:** Central European University, Quellenstraße 51, 1100 Vienna

**Registration:** The onsite event is already fully booked! You can request a Zoom link for virtual attendance from [Alíz Horváth via email](mailto:HorvathA@ceu.edu).
