...
summary: >-
  As part of the DH Forum of the MV Symposium, the NFDI4Memory Task Area 5 'Data
  Culture' organises a World Café on 'Historical Research Data' together with
  the Medievalists' Association. The event aims to collect & discuss the acute
  problems and needs of working with historical research data and the resulting
  goals and expectations of research data infrastructures from the community.
---
