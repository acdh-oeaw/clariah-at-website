...
summary: >
  ...
  XML).
image: /assets/content/assets/en/events/acdh-ch-tool-gallery-10-2/image.png
...
![](/assets/content/assets/en/events/acdh-ch-tool-gallery-10-2/funding-transkribus-en-final-v2.0-1024x576.png)

<Link link={{ discriminant: "pages", value: "funding-opportunities-for-junior-researcher" }}>Read more</Link>
...
This event is organised by the [Austrian Centre for Digital Humanities & Cultural Heritage](https://www.oeaw.ac.at/acdh/events/event-series/acdh-ch-tool-gallery-102) (ACDH-CH) in close cooperation with the [Institute for Medieval Research (IMAFO)](https://www.oeaw.ac.at/en/imafo/home) at the <Link link={{ discriminant: "consortium", value: "austrian-academy-of-sciences" }}>Austrian Academy of Sciences</Link> with the kind support of CLARIAH-AT.

***

<Link link={{ discriminant: "pages", value: "funding-opportunities-for-junior-researcher" }}>Funding Opportunities</Link>
