...
date: 2023-06-12
summary: >
  16.06.23, onsite (Vienna); In this Tool Gallery, you will learn how to use
  Transkribus in order to be able to use the possibility of automated text
  transcription for your documents.
image: /assets/content/assets/en/events/acdh-ch-tool-gallery-9-2-transkribus-for-beginners/image.png
...
Installation instructions for the Expert Client:[https://help.transkribus.com/de/herunterladen-und-installieren-von-transkribus-expert](https://help.transkribus.com/de/herunterladen-und-installieren-von-transkribus-expert)
